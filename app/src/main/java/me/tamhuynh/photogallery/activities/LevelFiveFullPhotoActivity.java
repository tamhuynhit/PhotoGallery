 ...
 */
public class LevelFiveFullPhotoActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setEnterSharedElementCallback(new SharedElementCallback() {
            ...
            public void onSharedElementEnd(List<String> sharedElementNames,
                ...
                if (mPendingImageView != null && mPendingImage != null) {
                    mPendingImageView.setImageDrawable(mPendingImage);
    ...
    private class PhotoPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, final int position) {
            ...
            final PhotoView photoView = new PhotoView(LevelFiveFullPhotoActivity.this);
            ...
            RequestBuilder<Drawable> thumbnailBuilder =  Glide.with(LevelFiveFullPhotoActivity.this)
            ...
            if (position == mCurrentIndex) {
                thumbnailBuilder = thumbnailBuilder.listener(new RequestListener<Drawable>() {
                    ...
                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                        ...
                        Toast.makeText(LevelFiveFullPhotoActivity.this, "Load image fail", Toast.LENGTH_SHORT).show();
            ...
            Glide.with(LevelFiveFullPhotoActivity.this)
                    ...
                    .into(new SimpleTarget<Drawable>() {
                        ...
                        public void onResourceReady(@NonNull Drawable resource, @Nullable Transition<? super Drawable> transition) {
                            if (position == mCurrentIndex && !isTransitionEnd) {
                                mPendingImageView = photoView;
                                mPendingImage = resource;
                            } else {
